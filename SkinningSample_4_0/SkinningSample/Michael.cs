...
{
    public class Michael : GameScreen
    {
       ...
       bool coveredByOtherScreen)
        {
            ...
            if (!ScreenManager.globalInput.pause)
                ScreenManager.p1June.UpdateMichael(gameTime);
        ...
        public void DrawMichael(JuneXnaModel player)
        {
            ...
            {
                draw = false;
                if (mesh.Name == "Alecto" || mesh.Name == "RSword" || mesh.Name == "TorsoPlate" ||
                    mesh.Name == "lHairF" || mesh.Name == "lHairB" || mesh.Name == "ponytail" ||
                    mesh.Name == "shin")
                {
 ...
 || mesh.Name == "W2,0" || mesh.Name == "W2,1" || mesh.Name == "W2,2")
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            DrawMichael(ScreenManager.p1June);
