...
{
    public class HerculesVsThor : GameScreen
    {
        Camera cam1= new Camera();
        public HerculesVsThor()
        {


            cam1.State = 0;
            cam1.ChaseDirection = Vector3.Forward;
            cam1.ChasePosition = ScreenManager.HercTVH.World.Translation;
            ...
            cam1.LookAtOffset = new Vector3(0.0f, 50.0f, 200.0f);
            cam1.DesiredPositionOffset = new Vector3(0.0f, 1000.0f, -250.0f);
       ...
       bool coveredByOtherScreen)
        ...
        public void DrawHercules(JuneXnaModel player)
        {
            ...
            {
                draw = false;
                if (mesh.Name == "Hercules" || mesh.Name == "ponytail")
                {
                    foreach (Effect effect in mesh.Effects)
                    {
                        ...
                        effect.Parameters["EyePosition"].SetValue(Matrix.Invert(cam1.View).Translation);
                        if (mesh.Name == "Hercules")
                        {
                        ...
                        effect.Parameters["WorldViewProj"].SetValue(cam1.View * cam1.Projection);
