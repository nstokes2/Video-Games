...
{
    public class ThorVsHercules : GameScreen
    {

        public ThorVsHercules()
        {
       ...
       bool coveredByOtherScreen)
        {
            ...
            if (!ScreenManager.globalInput.pause)
                ScreenManager.p1June.UpdateThor(gameTime);
        ...
        public void DrawThor(JuneXnaModel player)
        {
            ...
            foreach (ModelMesh mesh in ScreenManager.juneModel.Meshes)
            {
                ...
                || mesh.Name == "shin" || mesh.Name == "Mjolnir" || mesh.Name == "ponytail" || mesh.Name == "Scalp" || mesh.Name == "GreekPants")
                {
